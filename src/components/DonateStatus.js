...
const Option = ({ name, money, getOptionMoney }) => {
    ...
    return (
        <div className='donation-option'>
            ...
            {name === '任意捐' ? <label className='cursor-pointer px-2 py-1 border-2 hover:border-blue-500 hover:text-blue-500 focus:text-blue-500 rounded-md' for={name}>{name}
            </label> : <label className='cursor-pointer px-2 py-1 border-2 hover:border-blue-500 hover:text-blue-500 focus:text-blue-500 rounded-md' for={name}>{name + '(' + money + '元)'}
            </label>}
...
const Donate = ({ id, option, leastMoney }) => {
        ...
        <div className='flex flex-col space-y-3 text-sm'>
            ...
            <div className='flex flex-wrap'>
                ...
                <form className='py-1 px-2'>
                    ...
                    ? 
                        <div className='flex'>
                            <input className='py-1 px-2 border focus:outline-none focus:border-blue-500' placeholder='请输入捐赠金额' 
                ...
                <Link to={'/donate/order/' + id + '/' + totalMoney} >
                    <button className='border-2 border-blue-500 hover:bg-blue-100 focus:outline-none px-3 py-1 rounded-md'
                    >立即捐赠</button>
                </Link>
            </div>
        </div>
