...
function Order() {
  ...
  // ReactDOM.render(
  //   <Countdown date={new Date(orderInfo.createTime).getTime() + 1115000} renderer={renderer} />,
    ...
    <div className="w-full flex flex-col ">
      ...
      <div className=" w-full flex flex-col-reverse md:flex md:flex-row py-4 px-8 md:px-16 bg-gray-50 md:space-x-4 space-y-2">
          ...
          <div className="flex flex-col py-2 px-4 shadow-md bg-white">
            ...
            <div className="flex flex-col md:flex-row md:space-x-2 md:space-y-0 space-y-2">
              <div className="bg-green-400 flex px-4 py-2 rounded-xl shadow-md hover:shadow-xl cursor-pointer">
                ...
                <div className="my-auto px-4 text-xl text-white" onClick={wxPay}>
                  微信支付
                </div>
              </div>
              {!isWeixn() && (
                <div className="bg-blue-500 flex px-4 py-2 rounded-xl shadow-md hover:bg-blue-600 hover:shadow-xl cursor-pointer">
                  ...
                  <div className="my-auto px-4 text-xl text-white" onClick={aliPay}>
                    支付宝
                  </div>
                </div>
              )}
        ...
        <div className=" flex-grow h-1/2 bg-black opacity-70 text-white rounded-xl px-8 py-4">
          ...
          <div className="px-1 py-1 text-3xl font-bold ">￥ {orderInfo.money} CNY</div>
        </div>
      </div>
      <Footer />
    </div>
